...
app.delete('/coffeeorders/coffee/:coffee', (req, res) => {
    ...
    if (record) {
        db.coffeeorders.remove( { coffee: record.coffee }, false );
        res.sendStatus(200);
    }
    else res.sendStatus(404);
});
...
app.delete('/coffeeorders/flavor/:flavor', (req, res) => {
    ...
    if (record) {
        db.coffeeorders.remove( { flavor: record.flavor }, false );
        res.sendStatus(200);
    }
    else res.sendStatus(404);
});
...
app.delete('/coffeeorders/strength/:strength', (req, res) => {
    ...
    if (record) {
        db.coffeeorders.remove( { strength: record.strength }, false );
        res.sendStatus(200);
    }
    else res.sendStatus(404);
});
...
app.delete('/coffeeorders/size/:size', (req, res) => {
    ...
    if (record) {
        db.coffeeorders.remove( { size: record.size }, false );
        res.sendStatus(200);
    }
    else res.sendStatus(404);
});
